---
title: "Châtel-Soulet et al. 2024"
...
# Replace for more estetics
sce$cell_type_fast_Louvain_Cluster = str_replace(sce$cell_type_fast_Louvain_Cluster ,'LSK-','')

## TSNE colored by final_clustering 
## --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
plotReducedDim(sce, dimred="TSNE_MNN_Sample_k50", colour_by="final_clustering" ) + myTheme + xlab('TSNE.1') + ylab('TSNE.2') + coord_fixed( ) 

## TSNE colored by cell_type_fast_Louvain_Cluster (scale color manual) 
## --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
plotReducedDim(sce, dimred="TSNE_MNN_Sample_k50", colour_by="cell_type_fast_Louvain_Cluster" )+  scale_color_manual(name = "",values=c('PRIMITIVE'='#296DA0','PRIMED'='#ADB55F','METABOLISM'='#259461','CELL-CYCLE'='#7E5146','INTERFERON CELL-CYCLE'='#C971A1','INTERFERON'='#795291','ACUTE-ACTIVATION'='#C32B2C','MYELOID'='#31B6BF'))  + myTheme + xlab('TSNE.1') + ylab('TSNE.2' ) + coord_fixed( ) 

## TSNE colored by cell cycle phases 
## --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
plotReducedDim(sce, dimred="TSNE_MNN_Sample_k50", colour_by="phases" ) + myTheme + xlab('TSNE.1') + ylab('TSNE.2') + coord_fixed( ) 

## TSNE of subset of cells (gating)
## --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
### LT-HSC colored in red
colors = c (LTHSC="#e6194b",MPP0= "grey90",STHSC="grey90",MPP2="grey90",MPP3="grey90" ,no_gate='grey90')
plotReducedDim(sce[,which(sce$gating_fast=='LTHSC')], dimred="TSNE_MNN_Sample_k50", colour_by="gating_fast", size_by='gating_fast',shape_by = 'gating_fast') +  myTheme + coord_fixed( ) +
...
### MPP0 colored in yellow
colors = c (LTHSC="grey90",MPP0 ="#e5f531",STHSC="grey90",MPP2="grey90",MPP3="grey90" ,no_gate='grey90')
plotReducedDim(sce[,which(sce$gating_fast=='MPP0')], dimred="TSNE_MNN_Sample_k50", colour_by="gating_fast", size_by='gating_fast',shape_by = 'gating_fast') +  myTheme + coord_fixed( ) +
...
### ST-HSC/MPP1 colored in orange
colors = c (LTHSC="grey90",MPP0= "grey90",STHSC="#f58231",MPP2="grey90",MPP3="grey90" ,no_gate='grey90')
plotReducedDim(sce[,which(sce$gating_fast=='STHSC')], dimred="TSNE_MNN_Sample_k50", colour_by="gating_fast", size_by='gating_fast',shape_by = 'gating_fast') +  myTheme + coord_fixed( ) +
...
### MPP2 colored in blue
colors = c (LTHSC="grey90",MPP0= "grey90",STHSC="grey90",MPP2="#4363d8",MPP3="grey90" ,no_gate='grey90')
plotReducedDim(sce[,which(sce$gating_fast=='MPP2')], dimred="TSNE_MNN_Sample_k50", colour_by="gating_fast", size_by='gating_fast',shape_by = 'gating_fast') +  myTheme + coord_fixed( ) +
...
### MPP3/MPP4 colored in green
colors = c (LTHSC="grey90",MPP0= "grey90",STHSC="grey90",MPP2="grey90",MPP3="#3cb44b" ,no_gate='grey90')
plotReducedDim(sce[,which(sce$gating_fast=='MPP3')], dimred="TSNE_MNN_Sample_k50", colour_by="gating_fast", size_by='gating_fast',shape_by = 'gating_fast') +  myTheme + coord_fixed( ) +
